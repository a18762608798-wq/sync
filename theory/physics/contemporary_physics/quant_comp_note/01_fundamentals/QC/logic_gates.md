...
Y, Z is similar as X, we can think of them as NOT gates with rotation axes Y and
Z.
...
we can also think of it as a rotation $\pi$ with rotation of
$\frac{X + Z}{\sqrt 2}$
...
the proof is ref to [Hamming_Core_Estimation](../randomized_measurement/01_literature/00_proofs/hamming/Hamming_Core_Estimation.md#purity)
...
proof ref to [RZZ_composition](proofs/RZZ_composition.md)
...
This effect can be achieved by many different combinations of CNOT operations,
for instance,
...
**Any CNOT combination can achieve this operation as long as the control and the
transmission can reach the last qubit**.
