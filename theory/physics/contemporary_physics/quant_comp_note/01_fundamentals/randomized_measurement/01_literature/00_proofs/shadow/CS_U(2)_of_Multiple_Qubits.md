...
由于四个系数A可以被估计量反解只需要四个估计量，A覆盖了pair系统的所有泡利基，所以
最一般的pair估计量（足够表达n可以表达的所有态）形如
...
反正反对称映射全丢失，干脆让对称部分无偏，Let the result is
$\frac{1}{2}(\sigma_i\sigma_j + \sigma_j \sigma_i)$, Viz.,
...
所以对于任何对称的泡利基，可以正确映射。否则无法得到态。同样的，对于所需估计力学
量也是如此，只能命中对称的组分。
